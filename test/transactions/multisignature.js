...
describe('multisignature.js', function () {
	...
	var multisignature = moose.multisignature;
	...
	describe('#signTransaction', function () {
		...
		var secret = '123';
		var transaction = moose.transaction.createTransaction('58191285901858109M', 1000, 'secret');
	...
	describe('#createTransaction', function () {
		...
		var recipientId = '123456789M';
		var amount = '500';
		var secret = 'privateSecret';
		var secondSecret = 'privateSecondSecret';
		var requesterPublicKey = 'abc123';
		var msigTransaction = moose.multisignature.createTransaction(recipientId, amount, secret, secondSecret, requesterPublicKey);
		...
		it('should create a multisignature transaction without requesterPublicKey and secondSecret', function () {
			...
			var msigTransaction2 = moose.multisignature.createTransaction(recipientId, amount, secret);
			var pubKey = moose.crypto.getPrivateAndPublicKeyFromSecret(secret).publicKey;
